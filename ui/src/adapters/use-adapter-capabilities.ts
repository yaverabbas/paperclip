...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  ai_deflector_local: { supportsInstructionsBundle: false, supportsSkills: false, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: false, supportsModelProfiles: false, supportsAcp: false },
